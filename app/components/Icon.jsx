export default function Icon({ isHighScore }) {
  return (
    <svg
      viewBox="0 0 44 35"
      className={isHighScore ? "is-high-score" : undefined}
      role="img"
      aria-label={isHighScore ? "High score" : undefined}
      aria-hidden={isHighScore ? undefined : true}
    >
      <path
